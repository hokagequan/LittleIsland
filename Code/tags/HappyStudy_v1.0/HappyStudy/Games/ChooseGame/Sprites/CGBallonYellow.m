...
- (id)initWithString:(NSString *)string position:(CGPoint)position isAnswer:(BOOL)isAnswer {
    SKTextureAtlas *atlas = [SKTextureAtlas atlasNamed:@"CGBallonYellow_Death"];
...
+ (void)loadAssets {
    deathAnimationFrames = [GlobalUtil loadFramesFromAtlas:@"CGBallonYellow_Death" baseFileName:@"cgballon_yellow_death_" frameNum:10];
}
